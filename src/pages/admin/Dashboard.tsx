      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              <span className="font-medium text-yellow-600">{pendingOrders} đơn</span> đang chờ xử lý
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
              <TrendingUp className="h-3 w-3 text-green-500" />
              <span className="text-green-500 font-medium">+3</span> sản phẩm mới
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="hover:shadow-md transition-shadow">
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1 mt-1">
              ...
              <span className="text-red-500 font-medium">-2%</span> so với tháng trước
            </p>
          </CardContent>
        </Card>
      </div>
              ...
              <tbody>
                {recentOrders.map((order) => (
                  <tr key={order.id} className="border-b last:border-0 hover:bg-muted/50 transition-colors">
                    ...
                    <td className="py-4 px-4 text-sm font-medium">{order.customerName}</td>
