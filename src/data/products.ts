...
export const categories = [
  {
    ...
    name: "Chăm sóc da",
    subcategories: [
      { name: "Sữa rửa mặt", children: ["Sữa rửa mặt dạng gel", "Sữa rửa mặt dạng bọt", "Sữa rửa mặt dạng dầu"] },
      { name: "Toner", children: ["Toner cấp ẩm", "Toner làm sáng da", "Toner se khít lỗ chân lông"] },
      { name: "Serum", children: ["Serum Vitamin C", "Serum Retinol", "Serum HA"] },
      { name: "Kem dưỡng", children: ["Kem dưỡng ban đêm", "Kem dưỡng ban ngày", "Kem dưỡng ẩm"] },
      { name: "Mặt nạ", children: ["Mặt nạ giấy", "Mặt nạ đất sét", "Mặt nạ ngủ"] },
      { name: "Kem chống nắng", children: ["Kem chống nắng vật lý", "Kem chống nắng hóa học", "Xịt chống nắng"] },
    ],
  },
  {
    id: 2,
    name: "Trang điểm",
    subcategories: [
      { name: "Son môi", children: ["Son kem", "Son lì", "Son tint", "Son dưỡng"] },
      { name: "Phấn nền", children: ["Cushion", "Foundation", "Phấn phủ"] },
      { name: "Mascara", children: ["Mascara dài mi", "Mascara cong mi"] },
      { name: "Kẻ mắt", children: ["Kẻ mắt nước", "Kẻ mắt chì", "Kẻ mắt sáp"] },
      { name: "Phấn má", children: ["Phấn má hồng", "Phấn má cam"] },
      { name: "Highlighter", children: ["Highlighter nhũ", "Highlighter kem"] },
    ],
  },
  {
    id: 3,
    name: "Chăm sóc tóc",
    subcategories: [
      { name: "Dầu gội", children: ["Dầu gội phục hồi", "Dầu gội sạch gàu"] },
      { name: "Dầu xả", children: ["Dầu xả mượt tóc", "Dầu xả giữ màu"] },
      { name: "Ủ tóc", children: ["Ủ tóc collagen", "Ủ tóc keratin"] },
      { name: "Dưỡng tóc", children: ["Tinh dầu dưỡng tóc", "Xịt dưỡng tóc"] },
      { name: "Tạo kiểu", children: ["Keo xịt tóc", "Sáp vuốt tóc"] },
    ],
  },
  {
    id: 4,
    ...
    subcategories: [
      { name: "Sữa tắm", children: ["Sữa tắm trắng da", "Sữa tắm nước hoa"] },
      { name: "Dưỡng thể", children: ["Body lotion", "Body butter"] },
      { name: "Lăn khử mùi", children: ["Lăn khử mùi nam", "Lăn khử mùi nữ"] },
      { name: "Nước hoa", children: ["Nước hoa nữ", "Nước hoa nam"] },
    ],
  },
  {
    id: 5,
    ...
    subcategories: [
      { name: "Vitamin", children: ["Vitamin C", "Vitamin E", "Multivitamin"] },
      { name: "Collagen", children: ["Collagen nước", "Collagen bột"] },
      { name: "Giảm cân", children: ["Trà giảm cân", "Viên uống giảm cân"] },
      { name: "Làm đẹp da", children: ["Viên uống trắng da", "Viên uống cấp nước"] },
    ],
  },
];
